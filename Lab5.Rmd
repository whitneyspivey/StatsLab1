...
Yes, the proportion is different because as the number of sample means increases, the means become more centralized around the mean of 10 with less spread/varaibility. 
...
```{r}
sampling_distribution <- replicate(10000, sd(rnorm(100, mean = 10, sd = 20)) )
hist(sampling_distribution)
